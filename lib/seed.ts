...
export const seed:DeskData={schools,openings:examples.map(o=>({...o,workflow:'Inbox',notes:''})),requests:[],runs:[],settings:{scope:'Tenure-track assistant professor; all CS areas and related ECE/EECS searches.',rankingRule:'Union of top-50 US CS departments across credible rankings; keep source, year, ties and method. Initial directory is a September 2026 snapshot, not an exhaustive union.',schedule:'Not scheduled. Create a Codex daily task for your own deployed URL using docs/research-prompt.md.'}};
