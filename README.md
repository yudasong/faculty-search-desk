...
Run `npx tsc --noEmit` and `node --test tests/research.test.mjs` (Node 24 recommended). The research tests use in-memory SQLite and a mocked provider; they never spend API credits.
